      ...
      <div className="w-full p-3 mb-3 rounded-lg border">
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-2">
          <div className="w-full p-3 md:text-base text-sm bg-gray-200 rounded-md">
            ...
            <div className="flex my-1.5 items-center gap-1">
              <h1 className="text-base font-light mr-1">Tanggal Transaksi: </h1>
              <h2 className="font-medium">23 November 2023</h2>
            </div>
            <div className="flex my-1.5 items-center gap-1">
              <h1 className="text-base font-light mr-1">Metode Pembayaran: </h1>
            ...
            <div className="flex my-1.5 items-center gap-1">
              ...
              <h2 className="font-normal">
                {' '}
                <span className="inline font-semibold">09878723</span> | Atas
                Nama: <span className="inline font-semibold">Irma maulana</span>{' '}
              </h2>
            </div>
          </div>
