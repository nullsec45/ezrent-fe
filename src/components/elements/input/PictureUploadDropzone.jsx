...
const PictureUploadDropzone = React.forwardRef(
  (
    ...
    return (
      <div>
        <div
          ...
          className="w-full relative grid place-content-center border border-gray-500 border-dashed rounded-lg bg-gray-200"
        >
          {/* Main File Input */}
...
PictureUploadDropzone.displayName = 'PictureUploadDropzone';
